...
data = pickle.loads(open("./files/logistical_regression_prediction.pickle", "rb").read())
data = np.array(data)
actual = data[0]
predicted = data[1]
states=["sober","drunk"]
...
plt.savefig('./docs/logistical_regression_confusion.png')
print("Logistical Regression Confusion Matrix has been saved to ./docs/logistical_regression_confusion.png")
plt.show()
